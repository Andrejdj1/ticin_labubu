  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Otkrijte našu čarobnu kolekciju od 16 jedinstvenih Labubu prijatelja! Originalni plišanci i brza dostava."
        />
        <meta name="keywords" content="labubu, plišanci, igračke, labubu tijana, anime, kawaii" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Labubu Tijana 👑 - Najslađi Labubu plišanci" />
        <meta property="og:description" content="Čarobna kolekcija od 16 jedinstvenih Labubu prijatelja!" />
        <meta property="og:image" content="https://ticin-labubu.vercel.app/pink-labubu-bow.png" />
        <meta property="og:url" content="https://ticin-labubu.vercel.app" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Labubu Tijana 👑 - Najslađi Labubu plišanci" />
        <meta name="twitter:description" content="Čarobna kolekcija od 16 jedinstvenih Labubu prijatelja!" />
        <meta name="twitter:image" content="https://ticin-labubu.vercel.app/pink-labubu-bow.png" />
        <link rel="canonical" href="https://ticin-labubu.vercel.app" />
          ...
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="md:hidden">
                <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-pink-600 p-2">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Stranica {currentPage} od {totalPages} - Prikazano {currentProducts.length} od {labubuProducts.length}{" "}
              proizvoda 🎀
            </p>
          </div>
